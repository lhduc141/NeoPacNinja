class Enemy {
  constructor(
    ...
    this.target = randomTargetsForEnemy[this.randomTargetIndex];
  ...
  isInRange() {
    let xDistance = Math.abs(ninja.getMapX() - this.getMapX());
    let yDistance = Math.abs(ninja.getMapY() - this.getMapY());
    if (ninja.isHidden()) {
      return false;
    }
    if (
